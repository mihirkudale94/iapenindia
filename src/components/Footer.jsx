      ...
      <div className="container footer-grid">
        ...
        <div className="footer-col footer-about">
          ...
          <p className="footer-text">
            Indian Association for Parenteral and Enteral Nutrition is a professional non-profit
            organization dedicated to advancing nutritional healthcare and clinical nutrition
            practices in India.
          </p>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/chapters">Chapters Directory</Link>
            </li>
            <li>
              <Link to="/core-groups">Clinical Core Groups</Link>
            </li>
            <li>
              <Link to="/courses">Courses & Education</Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/newsletter-anniversary-edition">Newsletter Archive</Link>
            </li>
            <li>
              <a href="https://jnutres.com/" target="_blank" rel="noopener noreferrer">
                Nutrition Journal
              </a>
            </li>
            <li>
        ...
        <div className="footer-col">
          ...
          <ul className="footer-links">
            ...
            <li>
              <Link to="/malnutrition">Malnutrition Activities</Link>
            </li>
          </ul>
        </div>
        ...
        <div className="footer-col">
          ...
          <p className="footer-text">
            Subscribe to our newsletter to receive the latest updates on conferences, webinars, and
            publications.
          </p>
