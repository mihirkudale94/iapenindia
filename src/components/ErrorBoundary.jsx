      ...
      return (
        ...
        >
          ...
          <p style={{ color: 'var(--text-muted)', maxWidth: '500px', marginBottom: '32px' }}>
            An unexpected error occurred in the application. Our team has been notified. Please try
            refreshing the page.
          </p>
          <button
          ...
          {import.meta.env.DEV && (
            ...
            >
              ...
              <pre style={{ fontSize: '12px', color: '#b91c1c' }}>
                {this.state.error && this.state.error.toString()}
              </pre>
              <pre style={{ fontSize: '12px', color: '#4b5563', marginTop: '8px' }}>
