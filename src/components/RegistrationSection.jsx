...
import { User, Mail, Phone, Briefcase, Award, Shield, FileText, Upload, AlertCircle, CreditCard, Clipboard } from 'lucide-react';
          ...
          <div className="form-container-box glass-panel">
            {isSubmitted ? (
              <div className="success-card text-center animate-fade">
                ...
                <p>
                  Thank you for registering for IAPEN India Membership. Your application has been logged with reference number <strong>IAPEN-2026-{Math.floor(1000 + Math.random() * 9000)}</strong>.
                </p>
              ...
              <form onSubmit={handleSubmit} className="membership-form">
                ...
                <div className="grid-2">
                  ...
                  <div className="form-group">
                    ...
                    {errors.profession && <span className="form-error"><AlertCircle size={12} /> {errors.profession}</span>}
                  </div>
                </div>
                ...
                <div className="grid-2">
                  ...
                  <div className="form-group">
                    ...
                    {errors.idType && <span className="form-error"><AlertCircle size={12} /> {errors.idType}</span>}
                  </div>
                </div>
