...
export const statsData = [
  ...
  { value: '17+', numeric: 17, suffix: '+', label: 'Clinical Core Groups', icon: <Users size={24} /> },
  { value: '5000+', numeric: 5000, suffix: '+', label: 'Registered Professionals', icon: <Award size={24} /> },
  { value: '25+', numeric: 25, suffix: '+', label: 'Educational CNEs Yearly', icon: <Calendar size={24} /> }
];
